...
<div class="border border-secondary bg-light p-5 rounded rounded-lg">
    ...
    <div class="form-add mb-3">
        {{  Form::open(array('action' => array('AdminController@addCV', 'experience')))}}
    ...
    <li class="list-group">
        ...
        <ul class="list-group-item mb-0">
            <div id="exp{{$experience->id}}">
                {{  Form::open(array('url' => array('admin/cv/experience', $experience->id), 'method' => 'patch'))}}
                    <div class="d-flex justify-content-around mx-1">
                        ...
                        <div class="flex-grow-1 mx-1">
                        {{Form::label('description', 'description')}}
                        {{Form::text('description', $experience->description ,['class' => 'form-control'])}}
                        </div>
                        <div class="row ml-auto mx-1 align-self-end">
                        {{Form::submit('Modifier',['class' => 'btn btn-warning btn-block w-auto mx-1'])}}
                        {{  Form::close()}}
                        {{Form::open(array('action' => array('AdminController@removeCV', 'experience' , $experience->id), 'method' => 'delete'))}}
...
<div class="border border-secondary bg-light p-5 rounded rounded-lg">
    <h1>competences</h1>
    <div class="form-add mb-3">
        {{  Form::open(array('action' => array('AdminController@addCV', 'competence')))}}
        <div class="d-flex justify-content-around px-1">
            <div class="mx-1">
            {{Form::label('titre', 'titre')}}
            {{Form::text('titre', null,['class' => 'form-control'])}}
    ...
    <li class="list-group">
        ...
        <ul class="list-group-item mb-0">
            <div id="exp{{$experience->id}}">
                {{  Form::open(array('url' => array('admin/cv/competence', $competence->id), 'method' => 'patch'))}}
...
<div class="border border-secondary bg-light p-5 rounded rounded-lg">
    <h1>formations</h1>
    <div class="form-add mb-3">
        {{  Form::open(array('action' => array('AdminController@addCV', 'formation')))}}
        <div class="d-flex justify-content-around px-1">
            <div class="mx-1">
            {{Form::label('titre', 'titre')}}
            {{Form::text('titre', null,['class' => 'form-control'])}}
    ...
    <li class="list-group">
        ...
        <ul class="list-group-item mb-0">
            <div id="exp{{$formation->id}}">
                {{  Form::open(array('url' => array('admin/cv/formation', $formation->id), 'method' => 'patch'))}}
                <div class="d-flex">
                    <div class="flex-grow-1 mx-1">
                        <div class="d-flex justify-content-between mx-1">
                    ...
                    <div class="d-flex align-items-end mx-1">
                        {{Form::submit('Modifier',['class' => 'btn btn-warning btn-block w-auto mx-1'])}}
                        {{  Form::close()}}
                        {{Form::open(array('action' => array('AdminController@removeCV', 'formation' , $formation->id), 'method' => 'delete'))}}
                        {{Form::submit('supprimer',['class' => 'btn btn-danger btn-block w-auto mx-1'])}}
                        {{Form::close()}}
                    </div>
                </div>
...
<div class="border border-secondary bg-light p-5 rounded rounded-lg">
    <h1>langages</h1>
    <div class="form-add mb-3">
        {{  Form::open(array('action' => array('AdminController@addCV', 'langage')))}}
        <div class="d-flex justify-content-around px-1">
            <div class="mx-1">
            {{Form::label('titre', 'titre')}}
            {{Form::text('titre', null,['class' => 'form-control'])}}
    ...
    <li class="list-group">
        ...
        <ul class="list-group-item mb-0">
            <div id="exp{{$experience->id}}">
                {{  Form::open(array('url' => array('admin/cv/langage', $langage->id), 'method' => 'patch'))}}
                    <div class="d-flex justify-content-between mx-1">
                        <div class="mx-1">
                        {{Form::label('titre', 'titre')}}
